    ...
    <article className={classes.detail}>
      ...
      <nav className={classes.navList}>
        ...
        <li>
          ...
          <p>{"3. （公司）的（姓名）建議我聯繫你，因為我們已經幫助過他們……"}</p>
        </li>
        <li>
          <div>
            <div className={classes.highLight}></div>
      ...
      <div className={classes.description}>
        <h2>隨著入站營銷技術的日益流行，您會認為冷呼叫已死，對嗎？</h2>
            ...
            <Card>
              ...
              <div className={classes.content}>
                ...
                <div className={classes.actions}>
                  <p>
                    At its best, sales is facilitation, not manipulation. Here,
                    guided by this philosophy, you'll learn 4 strategies to
                    improve your startup's revenue process. And bonus: I'll show
                    you how Close can help.
                  </p>
                </div>
